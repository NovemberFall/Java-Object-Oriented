...
```js
anotherCustomer = customer, what we were doing internally, 
Java was actually assigning the second customer class to point to the first calss. 
So in other words it just saved the memory address. It didn't create a separate class.
```
